...
<div class="sfWrapperContainer">
    ...
    <div class="clearfix">
       ...
       </div><div class="sfMostViewItems" style="float: right;">
...
<div class="cssClassDashBoardBottom">
  ...
  <h1 align="left"><pre>  Generate a QR code                                                                           Manage</pre></h1>
  <div style=" float: left;"><iframe src=".././Modules/AspxCommerce/AspxAdminDashBoard/QRlogic/qrcode.html" height="550" width="700" align="left" ></iframe> </div>
  <div style="float:right;">
   <a href="http://services.nirvanaspaandsalon.com/adminappointments.aspx" target="_blank">
   <input type="button" value="View/Edit Appointments" />
</a>
   <a href="http://services.nirvanaspaandsalon.com/scheduler.aspx" target="_blank">
   <input type="button" value="Disable Bookings" />
</a>
 <a href="http://services.nirvanaspaandsalon.com/viewfeedback.aspx" target="_blank">
   <input type="button" value="View Feedback" />
</a>
</div>
